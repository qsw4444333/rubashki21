...
<template>
    <NuxtLink to="/" class="to-index-page">
        <div>
...
<style scoped>
    ...
    .to-index-page {
        @apply p-2 rounded-2xl bg-primary flex w-96 items-center gap-4 justify-center transition-all shadow-primary duration-200;
