...
<template>
  <div class="modal-variants">
    <div
      class="modal-variant__item"
      :class="{
        'modal-variant__item-active': activeVariant[product.id] == variant.id,
      }"
      v-for="variant in variants"
      :key="variant.id"
    >
      <div
        class="modal-variant__item-active-icon"
        v-if="activeVariant[product.id] == variant.id"
      >
        <svg
          width="15"
          height="15"
        ...
        >
          <path
            d="M2.8125 7.97266L6.5625 11.7227L12.1875 3.28516"
            stroke="white"
            stroke-width="1.5"
