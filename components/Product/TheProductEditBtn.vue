...
<template>
    <div class="product-edit-btn" v-if="props.product.id == props.currentProduct.id">
        <TheLabel>Размер: {{ props.product.size.name }}</TheLabel><br>
        <TheLabel>Вариант: {{ props.product.variant.name }}</TheLabel><br>
        <TheLabel>Цена за шт.: {{ props.product.price }} руб</TheLabel>
        <div class="product-btn-inner">
            <div class="product-btn__btns">
                <div class="product-btn-left" @click="removeProduct(props.product)">
                ...
                <div class="product-btn-right" @click="addProduct(props.product);">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#FFF" class="size-6">
    ...
    .product-edit-btn {
        ...
        .product-btn-inner {
            ...
            .product-btn__btns {
                ...
                .product-btn-right, .product-btn-left {
