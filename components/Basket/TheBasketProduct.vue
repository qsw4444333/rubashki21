...
<template>
    <div class="product-mini__item">
        ...
        <div class="product-mini__item-right">
            <div class="product-mini__item-del" @click="removeProducts(props.product)">
                <svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M11.3628 6.75039L11.1015 13.5004M7.48532 13.5004L7.224 6.75039M14.7525 4.34289C15.0108 4.38189 15.2676 4.42314 15.5243 4.46739M14.7525 4.34289L13.9458 14.7551C13.9129 15.1791 13.7201 15.575 13.4058 15.8638C13.0916 16.1526 12.6792 16.313 12.251 16.3129H6.33581C5.90765 16.313 5.49522 16.1526 5.181 15.8638C4.86678 15.575 4.67392 15.1791 4.641 14.7551L3.83438 4.34289M14.7525 4.34289C13.8808 4.21203 13.0046 4.11271 12.1257 4.04514M3.83438 4.34289C3.57608 4.38114 3.31929 4.42239 3.0625 4.46664M3.83438 4.34289C4.70605 4.21203 5.58224 4.11271 6.46118 4.04514M12.1257 4.04514V3.35814C12.1257 2.47314 11.4384 1.73514 10.5472 1.70739C9.71155 1.68087 8.8753 1.68087 8.03968 1.70739C7.14847 1.73514 6.46118 2.47389 6.46118 3.35814V4.04514M12.1257 4.04514C10.2403 3.90045 8.34653 3.90045 6.46118 4.04514" stroke="black" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            </div>
            ...
            <div class="product-mini__item-amount">
                <div class="product-mini__item-amount-left" @click="removeProduct(props.product)">
                ...
                <div class="product-mini__item-amount-right" @click="addProduct(props.product)">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#FFF" class="size-6">
...
<style>
    ...
    .product-mini__item {
        ...
        .product-mini__item-right {
            ...
            .product-mini__item-size, .product-mini__item-size, .product-mini__item-variant, .product-mini__item-price {
            ...
            .product-mini__item-amount {
                ...
                .product-mini__item-amount-left, .product-mini__item-amount-right {
